    ...
    <section className="hero-future relative w-full min-h-screen flex flex-col justify-end overflow-hidden">
      ...
      <div className="relative px-6 md:px-12 pb-6 max-w-4xl" style={{ zIndex: 5 }}>
        ...
        <div className="au1 hero-eyebrow inline-flex items-center gap-2.5 mb-5">
          ...
          <span className="text-orange text-[11px] uppercase" style={{ letterSpacing: '0.4em', fontFamily: 'Barlow, sans-serif' }}>
            H.O.G Algiers Chapter Algeria &nbsp;·&nbsp; Accréditation #8062
          </span>
        </div>

        {/* H1 */}
        <h1 className="au2 font-display m-0 hero-title" style={{ fontSize: 'clamp(52px, 8.7vw, 118px)', lineHeight: '0.98', letterSpacing: '1.5px' }}>
          <span className="block text-white hero-title-white">
            H.O.G TOUR 2026 ®
          </span>
          <span className="block text-white hero-title-white">
            PREMIÈRE FOIS EN
          </span>
          <span className="block text-orange hero-title-orange">
            ALGÉRIE
          </span>
        </h1>
        ...
        <p className="au3 font-condensed font-normal leading-relaxed mt-5 mb-10 max-w-[560px]"
          style={{ fontSize: 'clamp(14px, 1.75vw, 18px)', letterSpacing: '3px', textTransform: 'uppercase', color: 'rgba(255,255,255,.70)' }}>
